...
public class RadialSpectrum {
	...
	public double RadialFrame() { return RadialFrame(null, null, 9, 1);	}
	public double noFrame(double []vx, int nvp)	  { return noFrame(vx, null, nvp, 0); }
	...
	public double noFrame(double []vx, String []strlbl, int nvp, int type)	{
		GetRect();
		double d=__min(h,w), r=d/2, ri;
		r*=0.95; ri=r;
		return radius=ri;
	}
